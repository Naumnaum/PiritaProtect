...
public class TimerHandlers implements Listener {
	...
	public void UpdatePVP(final PiritaProtect main) {
	...
	public void PlayerTeleport(PlayerTeleportEvent Event) {
		if (Event.getPlayer() == null)
			return;
		if (!PiritaProtect.Plugin.getConfig().getBoolean("PreventPVPTeleport"))
			return;
	...
	public void PlayerLogout(PlayerQuitEvent Event) {
		if (Event.getPlayer() == null)
			return;
		if (!PiritaProtect.Plugin.getConfig().getBoolean("PreventPVPLog"))
			return;
		if (isPlayerInPVP(Event.getPlayer())) {
