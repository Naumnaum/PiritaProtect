...
public class Region {
	...
	public Boolean isInside(Location Loc, boolean Y) {
		...
		World wLoc = loc.getWorld();
		World pLoc = corner1.getWorld();
		...
		//alterado por Naumnaum
		return (x >= xMin && x <= xMax && z >= zMin && z <= zMax && y >= yMin && y <= yMax && wLoc.equals(pLoc));
	}
	...
	public Boolean zonesIntersect(Region Region1, boolean Y) {
		...
		//adcionado por Naumnaum
		World wLoc = Region1.getCorner1().getWorld();
		World pLoc = corner1.getWorld();
